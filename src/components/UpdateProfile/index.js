...
import {MainContainer, TextH1, Data , UserInfo, Form, Alert, NavBtnLink,
       FormLabel, FormInput, SecondaryContainer, AvatarContainer} from './UpdateProfileElements'
                        ...
                        <UserInfo>
                            ...
                            <Data>
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <FormInput type='text' ref={nameRef} placeholder={user.fullname}/>
                                    <FormLabel id="email">Email</FormLabel>
                                    <FormInput type='email' ref={emailRef} placeholder={user.email}/>
                                    <FormLabel id="password">Password</FormLabel>
                                    <FormInput type='password' ref={passwordRef} placeholder="Leave blank to keep the same"/>
                                    <FormLabel id="passwordConfirm">Password confirm</FormLabel>
